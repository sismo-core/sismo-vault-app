      ...
      <Content>
        ...
        <Explanations>
          ...
          <Text style={{ marginBottom: 5 }}>
            When minting a Badge, you must select a Destination account. Badges
            are minted on Destination accounts using data from Eligible
            accounts. Destination accounts are public-facing, while Eligible
            accounts remain private.
          </Text>

          <SectionTitle>
            Are Destination accounts linked to Eligible accounts?{" "}
          </SectionTitle>
          <Text>
          ...
          <SectionTitle>
            What should I use as a Destination account?
          </SectionTitle>
          <Text style={{ marginBottom: 10 }}>
            Badges are ideal reputation curation tools that allow you import
            data from one account to another. Projects can gate their
            applications by integrating Badges as an access control tool.
          </Text>
          <Text style={{}}>
            For example:
            <ul style={{ marginLeft: 25, paddingLeft: 0 }}>
              <li>
                You can mint a ZK Badge on a fresh Destination account and use
                it to anonymously access gated applications.
              </li>
              <li>
                You can mint ZK Badges on your public ENS address using data
                from your private Eligible accounts leaving no links between the
                two.
              </li>
            </ul>
          </Text>
          ...
          <SectionTitle>
            How do I import a Destination account into my Vault?{" "}
          </SectionTitle>
          <Text style={{ marginBottom: 5 }}>
            To import a Destination account into your Vault, you simply sign the
